...
hl.bind(mainMod .. " + Return",     hl.dsp.exec_cmd(launchPrefix .. vars.apps.terminal))
hl.bind(mainMod .. " + E",          hl.dsp.exec_cmd(launchPrefix .. vars.apps.file_manager))
hl.bind(secondMod .. " + T",        hl.dsp.exec_cmd(launchPrefix .. vars.apps.editor))
hl.bind(mainMod .. " + C",          hl.dsp.exec_cmd(launchPrefix .. vars.apps.calculator))
hl.bind("XF86Calculator",           hl.dsp.exec_cmd(launchPrefix .. vars.apps.calculator))
hl.bind(mainMod .. " + W",          hl.dsp.exec_cmd(launchPrefix .. vars.apps.browser))
hl.bind("CONTROL + SHIFT + Escape", hl.dsp.exec_cmd(launchPrefix .. vars.apps.terminal .. " -e btop"))
...
hl.bind(secondMod .. " + CONTROL + Right",      hl.dsp.window.move({ workspace = "m+1" }))
hl.bind(secondMod .. " + CONTROL + Left",       hl.dsp.window.move({ workspace = "m-1" }))
hl.bind(secondMod .. " + CONTROL + mouse_up",   hl.dsp.window.move({ workspace = "m-1" }))
hl.bind(secondMod .. " + CONTROL + mouse_down", hl.dsp.window.move({ workspace = "m+1" }))
-- hl.bind(secondMod .. " + mouse_up",             hl.dsp.window.move({ monitor   = "-1" }))
-- hl.bind(secondMod .. " + mouse_down",           hl.dsp.window.move({ monitor   = "+1" }))
...
hl.bind(secondMod .. " + W", hl.dsp.exec_cmd(noctCall .. "panel-toggle wallpaper"))
